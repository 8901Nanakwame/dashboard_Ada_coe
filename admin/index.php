...
<body>
    ...
    <nav class="navbar navbar-dark bg-success fixed-top">
            ...
            <div class="offcanvas offcanvas-start shadow" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        <li><a href="index.php"><i class="bi bi-calendar3"></i> <span class="item-text">Calendar</span></a></li>
                        <li><a href="content/"><i class="bi bi-pencil-square"></i> <span class="item-text">Applications</span></a></li>
  ...
  <div class="row justify-content-center ">
    <div class="cool">
      <?php include('../form/display/displaydb.php') ?>
    </div>
  </div>
</div>
  </section>
