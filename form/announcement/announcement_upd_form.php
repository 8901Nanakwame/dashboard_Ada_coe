...
<center><H1>ANNOUNCEMENT UPDATE DATA</h1></center>
...
<div class="form m-3  ">
<form action="annoucement_update.php" method="post" class="mt-5 " accept-charset="utf-8"  enctype="multipart/form-data">
